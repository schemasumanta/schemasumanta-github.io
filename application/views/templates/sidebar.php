        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('landing') ?>">
                ...
                <div class="sidebar-brand-text mx-3">JOB FINDER</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Pendidikan</a>
                        <a class="collapse-item" href="buttons.html">Agama</a>
                        <a class="collapse-item" href="buttons.html">Level Pekerjaan</a>
                        <a class="collapse-item" href="buttons.html">Skill</a>
                        <a class="collapse-item" href="buttons.html">Job Provider</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="login.html">Visitor</a>
                        <a class="collapse-item" href="login.html">Job Provider</a>
                        <a class="collapse-item" href="login.html">Job Seeker</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    ...
                                    src="<?php echo base_url().$this->session->photo_user ?>">
                            </a>
